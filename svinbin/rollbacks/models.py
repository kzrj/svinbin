...
class RollbackManager(CoreModelManager):
    ...
    def create_piglets_weighing_rollback(self, event_pk, initiator=None, date=None):
        wp = WeighingPiglets.objects.get(pk=event_pk)
        wp.piglets_group.change_status_to('Готовы ко взвешиванию')
        wp.delete()

        return self.create(initiator=initiator, date=date, operation_name='piglets_weighing',
            workshop=wp.initiator.employee.workshop, user_employee=wp.initiator)

    def create_piglets_culling_rollback(self, event_pk, initiator=None, date=None):
        cp = CullingPiglets.objects.get(pk=event_pk)
        cp.piglets_group.add_piglets(quantity=cp.quantity)
        cp.delete()

        return self.create(initiator=initiator, date=date, operation_name='piglets_culling',
            workshop=cp.initiator.employee.workshop, user_employee=cp.initiator)

    def create_piglets_transactions_rollback(self, event_pk, initiator=None, date=None):
        ...
        return self.create(initiator=initiator, date=date, operation_name='piglets_transaction',
            workshop=transaction.initiator.employee.workshop,
            user_employee=transaction.initiator)

    def create_piglets_to_sows_event_rollback(self, event_pk, initiator=None, date=None):
        ...
        return self.create(initiator=initiator, date=date, operation_name='piglets_to_sows_event',
            workshop=pts_event.initiator.employee.workshop,
            user_employee=pts_event.initiator)

    def create_mark_as_gilt_rollback(self, event_pk, initiator=None, date=None):
        mag_event = MarkAsGilt.objects.get(pk=event_pk)
        mag_event.delete_gilt_and_event()

        return self.create(initiator=initiator, date=date, operation_name='mark_as_gilt',
            workshop=mag_event.initiator.employee.workshop,
            user_employee=mag_event.initiator)

    def create_ws3_weaning_piglets_rollback(self, event_pk, initiator=None, date=None):
        transaction = PigletsTransaction.objects.get(pk=event_pk)
        ...
        return self.create(initiator=initiator, date=date, operation_name='ws3_piglets_weaning',
            workshop=transaction.initiator.employee.workshop,
            user_employee=transaction.initiator)

    def create_mark_as_nurse_rollback(self, event_pk, initiator=None, date=None):
        ...
        return self.create(initiator=initiator, date=date, operation_name='mark_as_nurse',
            workshop=mas_event.initiator.employee.workshop,
            user_employee=mas_event.initiator)

    def create_farrow_rollback(self, event_pk, initiator=None, date=None):
        ...
        return self.create(initiator=initiator, date=date, operation_name='farrow',
            workshop=farrow.initiator.employee.workshop,
            user_employee=farrow.initiator)

    def create_abort_rollback(self, event_pk, initiator=None, date=None):
        ...
        return self.create(initiator=initiator, date=date, operation_name='abort',
            workshop=abort.initiator.employee.workshop,
            user_employee=abort.initiator)

    def create_sow_culling_rollback(self, event_pk, initiator=None, date=None):
        ...
        return self.create(initiator=initiator, date=date, operation_name='culling_sow',
            workshop=culling.initiator.employee.workshop,
            user_employee=culling.initiator)

    def create_ultrasound_rollback(self, event_pk, initiator=None, date=None):
        ...
        return self.create(initiator=initiator, date=date, operation_name='usound',
            workshop=usound.initiator.employee.workshop,
            user_employee=usound.initiator)

    def create_semination_rollback(self, event_pk, initiator=None, date=None):
        ...
        return self.create(initiator=initiator, date=date, operation_name='semination',
            workshop=semination.initiator.employee.workshop,
            user_employee=semination.initiator)

    def create_sow_transaction_rollback(self, event_pk, initiator=None, date=None):
        ...
        return self.create(initiator=initiator, date=date, operation_name='sow_transaction',
            workshop=transaction.initiator.employee.workshop,
            user_employee=transaction.initiator)
